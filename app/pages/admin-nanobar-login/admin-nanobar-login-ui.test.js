// Integration tests for admin-nanobar-login-ui.js: loads the real admin-nanobar-login.html into jsdom and
...
const html = readFileSync(join(__dirname, "admin-nanobar-login.html"), "utf8");

const dom = new JSDOM(html, { url: "https://example.test/admin/nanobar/login" });
globalThis.window = dom.window;
globalThis.document = dom.window.document;

const ui = await import("./admin-nanobar-login-ui.js");
