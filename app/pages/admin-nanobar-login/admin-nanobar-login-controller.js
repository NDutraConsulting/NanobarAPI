// admin-nanobar-login-controller.js
// Orchestrates the admin login page: reads the submitted credential, calls
// admin-nanobar-login-api.js, hands results to admin-nanobar-login-ui.js, and redirects on success.
// This is the only file with top-level "run on page load" logic.

import * as api from "./admin-nanobar-login-api.js";
import * as ui from "./admin-nanobar-login-ui.js";
