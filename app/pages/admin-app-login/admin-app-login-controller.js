// admin-app-login-controller.js
// Orchestrates the admin login page: reads the submitted credential, calls
// admin-app-login-api.js, hands results to admin-app-login-ui.js, and redirects on success.
// This is the only file with top-level "run on page load" logic.

import * as api from "./admin-app-login-api.js";
import * as ui from "./admin-app-login-ui.js";
