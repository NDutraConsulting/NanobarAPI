// Integration tests for admin-app-login-ui.js: loads the real admin-app-login.html into jsdom and
...
const html = readFileSync(join(__dirname, "admin-app-login.html"), "utf8");

const dom = new JSDOM(html, { url: "https://example.test/admin/app/login" });
globalThis.window = dom.window;
globalThis.document = dom.window.document;

const ui = await import("./admin-app-login-ui.js");
