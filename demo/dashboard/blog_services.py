...
example scaled to a real multi-route domain. Backed by `blog_repositories.py`.
"""
...
from .blog_models import PostStateFields
from .blog_repositories import AppointmentRepository, NotificationRepository, PostRepository
from .blog_serialize import appointment_to_dict, notification_to_dict, post_to_dict
...
class BookAppointmentService(NanobarService):
    ...
    anything about the notification itself -- `blog_notifications.py`'s `NanobarCallback`
