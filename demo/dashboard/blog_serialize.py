"""ORM row -> plain JSON-able dict, shared by `blog_services.py` (service response payloads) and
the plain read-only handlers in `admin_app_routes.py`/`blog_public_routes.py`.
"""
...
from .blog_models import Appointment, Notification, Post
