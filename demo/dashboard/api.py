...
async def refresh_nanobars_action(request: Request) -> JSONResponse:
    ...
    `demo/dashboard/nanobar_refresh.py`'s module docstring for why. Recorded as the
...
async def replay_brick_action(request: Request) -> JSONResponse:
    ...
    shadow_app = get_replay_app(
        ...
        admin_db_path=request.app.state.admin_db_path,
    ...
    session_backend = SQLiteSessionBackend(shadow_app.state.admin_db_path)
